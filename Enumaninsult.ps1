...
#----------------------------------------------------------------------------------------------------
    $lowRAM = "$RAM gigs of ram? is this a bloody etch a sketch"
    
    $okRAM = "$RAM gigs of ram really? yawn"
    
    $goodRAM = "$RAM gigs of ram? how does it feel to be average"

    $impressiveRAM = "$RAM gigs of ram? fucking hell"
#----------------------------------------------------------------------------------------------------
...
# ENTER YOUR CUSTOM RESPONSES HERE
#----------------------------------------------------------------------------------------------------
    $badPASS = "$pro is a lame name but at least it is not as shit as your wifi password... $pwl characters long? $pass ...? really..? jesus christ"
    
    $okPASS = "$pro is a crap name but at least you tried, your password is $pwl characters long, still shit though.. $pass ...? shocking"
    
    $goodPASS = "$pro is a really bad name. $pwl character long password isnt bad, but not good enough. $pass isnt a bad password though."
#----------------------------------------------------------------------------------------------------
...
# ENTER YOUR CUSTOM RESPONSES HERE 
#---------------------------------------------------------------------------------------------------- 
    $newPass = "$pls was the last time you changed your password... You changed your password $days days ago..   at least you change your password often."
    
    $avgPASS = "$pls was the last time you changed your password... it has been $days days since you changed your password, really starting to push it" 
    
    $oldPASS = "$pls was the last time you changed your password... it has been $days days since you changed your password, do better next time"
#----------------------------------------------------------------------------------------------------      
...
# ENTER YOUR CUSTOM RESPONSES HERE
#----------------------------------------------------------------------------------------------------
    $gmailResponse = "YOu use Gmail like a basic bitch. $email. That is your email right?"
    $yahooResponse = "$email yahoo? ew"
    $hotmailResponse = "really?. you have a hotmail account? $email .. I am sending this to the police they need to check your hard drive"
    $otherEmailResponse = "I don't even know what this email is. $email .. how odd"
#----------------------------------------------------------------------------------------------------
...
$intro = "$fullName , how are you doing"
