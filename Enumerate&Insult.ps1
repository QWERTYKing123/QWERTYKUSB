...
#----------------------------------------------------------------------------------------------------
    $lowRAM = "$RAM gigs of ram? bro has an etch a sketch for a computer"
    
    $okRAM = "$RAM gigs of ram really? Poor git"
    
    $goodRAM = "$RAM gigs of ram? well done! you're average"

    $impressiveRAM = "$RAM gigs of ram? are you serious? hot damn"
#----------------------------------------------------------------------------------------------------
...
#----------------------------------------------------------------------------------------------------
    $badPASS = "$pro I have no words for how bad this is $pwl characters long? $pass ...? really..? $pass shocking"
    
    $okPASS = "$pro aww you tried, your password is $pwl characters long, still shit though.. $pass ...? You can do better"
    
    $goodPASS = "$pro finally, some semblence of competence. Evidently not enough though... $pwl characters long, if only you kept an eye on your USB ports... $pass is a decent password though."
#----------------------------------------------------------------------------------------------------
...
# This will open up notepad with all their saved networks and passwords and taunt them
	...
	$s.Speak("have some wifi passwords")
	Start-Sleep -Seconds 1
	$s.Speak("lol")
...
# ENTER YOUR CUSTOM RESPONSES HERE 
#---------------------------------------------------------------------------------------------------- 
    $newPass = "$pls was the last time you changed your password... You changed your password $days days ago..   well done "
    
    $avgPASS = "$pls was the last time you changed your password... it has been $days days since you changed your password, crikey " 
    
    $oldPASS = "$pls was the last time you changed your password... it has been $days days since you changed your password, idiot "
#----------------------------------------------------------------------------------------------------      
...
# ENTER YOUR CUSTOM RESPONSES HERE
#----------------------------------------------------------------------------------------------------
    $gmailResponse = "Could be worse, could be yahoo"
    $yahooResponse = "a yahoo account?		ew"
